...
#env_path = 'C:\Users\DESKTOP\OneDrive\Desktop\youtube_summarizer-main\.env/openai_api' # Change the Path
# Load the OpenAI API key from the .env file

openai.api_key = "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"
